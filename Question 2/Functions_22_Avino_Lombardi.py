...
def predict(
    ...
    **kwargs
    ...
    """
    '''
    # Select only active support vectors
    is_active = lambdas > tolerance
    X_sv = X_train[is_active]             # shape: (n_sv, d)
    Y_sv = Y_train[is_active]             # shape: (n_sv,)
    lambda_sv = lambdas[is_active]        # shape: (n_sv,)
    '''
